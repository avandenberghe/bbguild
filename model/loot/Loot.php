 ...
 * @property int $item_date
 * @property string $item_added_by
 * @property string $item_updated_by
 * @property int $item_group_key
 * @property string $game_id
 * @property int $wowhead_id
 * @property float $item_value
 * @property float $item_decay
 * @property float $item_net
 * @property int $item_zs
 * @property int $decay_time
 * @property array $lootdetails
 *
 */
class Loot
{
	 ...
	 * @usedby \sajaki\bbdkp\model\loot\LootController::delete_raid()
	 */
