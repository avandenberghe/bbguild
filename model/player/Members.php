 ...
 * @property bool $member_status
 * @property int $member_level
 * @property int $member_race_id
 * @property string $member_race
 * @property int $member_class_id
 * @property int $member_rank_id
 * @property string $member_comment
 * @property int $member_joindate
 * @property int $member_joindate_d
 * @property int $member_joindate_mo
 * @property int $member_joindate_y
 * @property int $member_outdate
 * @property int $member_outdate_d
 * @property int $member_outdate_mo
 * @property int $member_outdate_y
 * @property int $member_guild_id
 * @property string $member_guild_name
 * @property string $member_realm
 * @property string $member_region
 * @property string $regionlist
 * @property int $member_gender_id
 * @property int $member_achiev
 * @property string $member_armory_url
 * @property string $member_portrait_url
 ...
 * @property array $guildmemberlist
...
' . sprintf($user->lang['BBDKP_MEMBERACTIVATED'] , $user->data['username'], date( 'd.m.y G:i:s', $this->time ))  ,
	...
	public function Armory_getmember()
	{
		 ...
		 */
		$api = new BattleNet('character', $this->member_region, $game->getApikey(),$game->getApilocale() , $game->getPrivkey() , $this->ext_path);
     ...
     * @param string $member_filter optional = ''
     * @param int $all
     * @return array
     *
     */
