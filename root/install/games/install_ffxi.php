...
function install_ffxi_bb2($bbdkp_table_prefix)
{
	...
	{
		$sql_ary = array ();
		$sql_ary[] = array( 'id' => 1 , 'zonename' => 'Dummy Zone', 'zonename_short' =>  'Dummy Zone' , 'imagename' =>  'dummyzone' , 'game' =>  'ffxi' ,  'tier' =>  '' ,  'completed' =>  '0' ,  'completedate' =>  '0' ,  'webid' =>  '');
		$db->sql_multi_insert ( $bbdkp_table_prefix . 'bb_zonetable', $sql_ary );
		unset ( $sql_ary );

		$sql_ary[] = array('id' => 1 , 'bossname' => 'Dummy Boss' , 'bossname_short' => 'Dummy Boss', 'imagename' =>  'dummyboss' , 'game' =>  'ffxi' , 'zoneid' =>  1 , 'type' =>  'npc'  , 'webid' =>  '' , 'killed' =>  '0' , 'killdate' =>  '0' , 'counter' =>  '0'    );	
