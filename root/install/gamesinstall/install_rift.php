...
function install_rift()
{
	...
	$sql_ary [] = array ('game_id' => 'rift','race_id' => 1, 'race_faction_id' => 1,  'image_female_small' => 'rift_dwarf_female',  'image_male_small' => 'rift_dwarf_male'  ); //Human
	$sql_ary [] = array ('game_id' => 'rift','race_id' => 2, 'race_faction_id' => 1 , 'image_female_small' => 'rift_highelf_female',  'image_male_small' => 'rift_highelf_male' ); //Orc
	$sql_ary [] = array ('game_id' => 'rift','race_id' => 3, 'race_faction_id' => 1 , 'image_female_small' => 'rift_mathosian_female',  'image_male_small' => 'rift_mathosian_male' ); //Dwarf
	$sql_ary [] = array ('game_id' => 'rift','race_id' => 4, 'race_faction_id' => 2 , 'image_female_small' => 'rift_bahmi_female',  'image_male_small' => 'rift_bahmi_male' ) ; //Night Elf
	$sql_ary [] = array ('game_id' => 'rift','race_id' => 5, 'race_faction_id' => 2 , 'image_female_small' => 'rift_eth_female',  'image_male_small' => 'rift_eth_male' ); //Undead
	$sql_ary [] = array ('game_id' => 'rift','race_id' => 6, 'race_faction_id' => 2 , 'image_female_small' => 'rift_kelari_female',  'image_male_small' => 'rift_kelari_male' ); //Tauren
	$db->sql_multi_insert ( $table_prefix . 'bbdkp_races', $sql_ary );
	unset ( $sql_ary );
