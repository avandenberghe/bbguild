...
function install_lotro()
{
    ...
    // class : 
    $sql_ary[] = array('game_id' => 'lotro', 'class_id' => 0, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Unknown_small' );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 1, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Burglar_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 2, 'class_armor_type' => 'PLATE' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Captain_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 3, 'class_armor_type' => 'PLATE' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Champion_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 4, 'class_armor_type' => 'PLATE' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Guardian_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 5, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Hunter_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 6, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Lore-master_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 7, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Minstrel_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 8, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Rune-keeper_small'  );
    $sql_ary[] = array('game_id' => 'lotro','class_id' => 9, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 65, 'imagename' => 'lotro_Warden_small');   
    ...
    $sql_ary[] = array('game_id' => 'lotro','race_id' => 3, 'race_faction_id' => 1 ); //Elf
    $sql_ary[] = array('game_id' => 'lotro','race_id' => 4, 'race_faction_id' => 1 ); //Dwarf
