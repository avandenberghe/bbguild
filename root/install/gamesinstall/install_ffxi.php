...
function install_ffxi()
{
    ...
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 2, 'class_armor_type' => 'LEATHER' , 'class_min_level' => 1 , 'class_max_level'  => 75, 'imagename' => 'ffxi_Monk_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 3, 'class_armor_type' => 'LEATHER' , 'class_min_level' => 1 , 'class_max_level'  => 75, 'imagename' => 'ffxi_Thief_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 4, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75, 'imagename' => 'ffxi_White_Mage_small' ); 
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 5, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75, 'imagename' => 'ffxi_Black_Mage_small' ); 
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 6, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75, 'imagename' => 'ffxi_Blue_Mage_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 7, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75, 'imagename' => 'ffxi_Red_Mage_small' );  
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 8, 'class_armor_type' => 'PLATE' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Paladin_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 9, 'class_armor_type' => 'PLATE' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Dark_Knight_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 10, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Dragoon_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 11, 'class_armor_type' => 'LEATHER' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Ninja_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 12, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Samurai_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 13, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Summoner_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 14, 'class_armor_type' => 'LEATHER' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Ranger_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 15, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Dancer_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 16, 'class_armor_type' => 'CLOTH' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Scholar_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 17, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Corsair_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 18, 'class_armor_type' => 'MAIL' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Bard_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 19, 'class_armor_type' => 'LEATHER' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Beastmaster_small' );
    $sql_ary[] = array('game_id' => 'FFXI','class_id' => 20, 'class_armor_type' => 'LEATHER' , 'class_min_level' => 1 , 'class_max_level'  => 75 , 'imagename' => 'ffxi_Puppetmaster_small' );
    ...
    // Language table
    $db->sql_query('DELETE FROM ' . $table_prefix . "bbdkp_language  where game_id = 'FFXI' and (attribute='class' or attribute = 'race')");
    unset ($sql_ary); 
	$sql_ary = array();
