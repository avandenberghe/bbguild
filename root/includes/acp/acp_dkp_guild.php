...
class acp_dkp_guild extends \bbdkp\admin\Admin
{
            ...
            case 'editguild':
                ...
                switch($action)
                {
                    case 'guildranks':
                        ...
                        if ($updaterank || $addrank || $getarmorymembers)
                        {
     ...
     * @return void
     */
    private function UpdateGuild(\bbdkp\controller\guilds\Guilds $updateguild)
    {
        global $user;
    ...
    private function BuildTemplateEditGuildRecruitment($updateguild)
    {
        ...
        $listroles           = new \bbdkp\controller\guilds\Recruitment();
