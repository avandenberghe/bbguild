...
class acp_dkp_sys extends bbDkp_Admin
{
	...
	function error_check()
    {
        ...
        $this->fv->is_filled(array(
            request_var('dkpsys_name', ' ')  => $user->lang['FV_REQUIRED_NAME'])
        );
	...
	function main($id, $mode) 
	{
		...
		switch ($mode)
		{
			case 'adddkpsys':
					...
					if ($submit)
					{
						...
						$success_message = sprintf(
									$user->lang['ADMIN_UPDATE_DKPSYS_SUCCESS'],  $this->url_id,
			...
			case 'listdkpsys':
				...
				{
					$template->assign_block_vars('dkpsysdef_row', array(
				...
				$template->assign_vars(array(
				    ...
				    'DKPSYS_PAGINATION' => generate_pagination(append_sid("index.$phpEx", "i=dkp_sys&amp;mode=listdkpsys&amp;")."&amp;o=".$current_order['uri']['current'], $total_dkpsys, $config['bbdkp_user_elimit'],$start))
				);
