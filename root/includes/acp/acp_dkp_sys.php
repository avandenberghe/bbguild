		...
		switch ($mode)
		{
				 ...
				 * 	if (isset($config['bbdkp_bp_version']))
			{
				...
				$template->assign_vars(array(
						...
						'IMAGEPATH' 		=> $phpbb_root_path . "images/bbdkp/eventimages/" . $event->event_imagename . ".png",
				...
				if(isset($event->events))
				{
					foreach ($event->events as $id => $listevent)
					{
						$template->assign_block_vars('events_row', array(
								...
								'IMAGEPATH' 	=> $phpbb_root_path . "images/bbdkp/eventimages/" . $listevent['event_imagename'] . ".png",
