...
class install_vanguard extends \bbdkp\aGameinstall
{
	/**
	 * Installs factions
	 */
	...
	*/
	function InstallClasses()
	{
		...
		$db->sql_query('DELETE FROM ' . $table_prefix . "bbdkp_language  WHERE game_id = 'vanguard' and attribute='class' ");
		$sql_ary = array();
	...
	*/
	function InstallRaces()
	{
		...
		$sql_ary = array();
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 0, 'race_faction_id' => 1,  'image_female' => ' ',  'image_male' => ' '  ); //Unknown
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 1, 'race_faction_id' => 1,  'image_female' => 'vanguard_thestran',  'image_male' => 'vanguard_thestran'  ); //Thestran Human
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 2, 'race_faction_id' => 1 , 'image_female' => 'vanguard_dwarf',  'image_male' => 'vanguard_dwarf' ); ///Dwarf
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 3, 'race_faction_id' => 1 , 'image_female' => 'vanguard_halfling',  'image_male' => 'vanguard_halfling' ); ///Halfling
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 4, 'race_faction_id' => 1 , 'image_female' => 'vanguard_helf',  'image_male' => 'vanguard_helf' ) ; //High Elf
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 5, 'race_faction_id' => 1  , 'image_female' => 'vanguard_vulmane',  'image_male' => 'vanguard_vulmane' ); //Vulmane
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 6, 'race_faction_id' => 1 , 'image_female' => 'vanguard_varanjer',  'image_male' => 'vanguard_varanjer' ); //Varanjar
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 7, 'race_faction_id' => 2 , 'image_female' => 'vanguard_lgiant',  'image_male' => 'vanguard_lgiant' ); //Lesser Giant
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 8, 'race_faction_id' => 2 , 'image_female' => 'vanguard_kojani',  'image_male' => 'vanguard_kojani' ); //Kojani Human
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 9, 'race_faction_id' => 2 , 'image_female' => 'vanguard_welf',  'image_male' => 'vanguard_welf' ); //Wood Elf
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 10, 'race_faction_id' => 2 , 'image_female' => 'vanguard_aelf',  'image_male' => 'vanguard_aelf' ); //Half Elf
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 11, 'race_faction_id' => 2 , 'image_female' => 'vanguard_orc',  'image_male' => 'vanguard_orc' ); //Orc
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 12, 'race_faction_id' => 2 , 'image_female' => 'vanguard_goblin',  'image_male' => 'vanguard_goblin' ); //Goblin
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 13, 'race_faction_id' => 2 , 'image_female' => 'vanguard_raki',  'image_male' => 'vanguard_raki' ); //Raki
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 14, 'race_faction_id' => 3 , 'image_female' => 'vanguard_qual',  'image_male' => 'vanguard_qual' ); //Qaliathar
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 15, 'race_faction_id' => 3 , 'image_female' => 'vanguard_gnome',  'image_male' => 'vanguard_gnome' ); //Gnome
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 16, 'race_faction_id' => 3 , 'image_female' => 'vanguard_delf',  'image_male' => 'vanguard_delf' ); //Dark Elf
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 17, 'race_faction_id' => 3 , 'image_female' => 'vanguard_kurashasa',  'image_male' => 'vanguard_kurashasa' ); //Kurashasa
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 18, 'race_faction_id' => 3 , 'image_female' => 'vanguard_mordebi',  'image_male' => 'vanguard_mordebi' ); //Mordebi Human
		$sql_ary [] = array ('game_id' => 'vanguard','race_id' => 19, 'race_faction_id' => 3 , 'image_female' => 'vanguard_varan',  'image_male' => 'vanguard_varan' ); //Varanthari
		$db->sql_multi_insert( $table_prefix . 'bbdkp_races', $sql_ary);
		unset ( $sql_ary );
		
		$db->sql_query('DELETE FROM ' . $table_prefix . "bbdkp_language  WHERE game_id = 'vanguard' and attribute='race' ");
		$sql_ary = array();
