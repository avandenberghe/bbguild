	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'styles/subsilver2/theme/images/jqueryui/progressbar.gif',	// boxImage : image around the progress bar
				// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				//overridden
				barImage		: {
									5:   'styles/subsilver2/theme/images/jqueryui/progressbg_black.gif',
									20:  'styles/subsilver2/theme/images/jqueryui/progressbg_red.gif',
									40:  'styles/subsilver2/theme/images/jqueryui/progressbg_orange.gif',
									60:  'styles/subsilver2/theme/images/jqueryui/progressbg_yellow.gif',
									100: 'styles/subsilver2/theme/images/jqueryui/progressbg_green.gif'										
								},
