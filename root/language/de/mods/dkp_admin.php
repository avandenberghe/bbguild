...
'NOTREGISTERED' => 'nicht eingetragen',
...
'IMPORT_EQDKP132_CONFIRM' => 'Bist du bereit die Daten einzulesen ? die EQDKP Tabellennamen sollen mit ‘EQDKP‘ beginnen, nur Variabele Daten werden importiert, nicht die Statischen Daten wie Klassen usw.',
'IMPORT_EQDKP140' => 'Lese EQDKP 1.4.0 Daten in bbdkp 1.1.2 ein',
'IMPORT_EQDKP140_CONFIRM' => 'Bist du bereit die Daten einzulesen ? die EQDKP Tabellennamen sollen mit ‘EQDKP‘ beginnen, nur Variabele Daten werden importiert, nicht die Statischen Daten wie Klassen usw.',
'IMPORT_EQDKPPLUS' => 'Lese EQDKP-PLUS Daten in bbDKP 1.1.2 ein',
'IMPORT_EQDKPPLUS_CONFIRM' => 'Bist du bereit die Daten einzulesen ? die EQDKP+ Tabellennamen sollen mit ‘EQDKP‘ beginnen, nur Variabele Daten werden importiert, nicht die Statischen Daten wie Klassen usw.',
...
'UMIL_ITEMSTATS_HIDDEN' => 'Verstecktes Tooltipmodul hinzugefügt',
...
'UMIL_128MINIMUM' => 'Alte Version. 1.2.8 wird benötigt vom auf 1.3.0 aktualisieren',
'UMIL_GAME' => 'Spieldaten für %s installiert',
'UMIL_DUMMYDATA' => 'Besispieldaten eingefügt',
...
'TRANSFER_MEMBER_HISTORY_DESCRIPTION' => 'Hier kann die gesamte Geschichte (Raids, Gegenstände, Anpassungen) eines Mitglieds übertragen werden zu einen anderem Mitglied.',
...
'ARMORY_ENABLED_EXPLAIN' => 'ist die Armory API eingeschaltet für dieses Spiel? (Nur WoW und Guildwars haben eine öffentlich zugängliche Web API, aber bbDKP benutzt nur den WoW API).',
...
'CLASS_IMAGE_EXPLAIN' => 'png Farbblidname ohne Dateiendung. Diese Datei soll im Bereich "/images/class_images" existieren',
...
'ACP_DKP_LOOTSYSTEMEXPLAIN' => 'Hinweis zurmBeute Systeme',
...
'ACP_NEWGAME_EXPLAIN' => 'Hier kannst du ein eigenes oder vorprogrammiertes Spiel einschalten und bearbeiten.',
'ACP_EDITGAME_EXPLAIN' => 'Hier kannst du die statischen Elemente von MMO games bearbeiten: Faktionen, Klassen, rassen. <br />',
...
// Permission Messages
'NOAUTH_A_EVENT_ADD' => 'Du hast keine Berechtigung Ereignisse hinzu zufügen.',
...
'NOAUTH_A_INDIVADJ_ADD' => 'Du hast keine Berechtigung Anpassungen hinzu zufügen.',
...
'NOAUTH_A_ITEM_ADD' => 'Du hast keine Berechtigung Gegenstände hinzu zufügen.',
...
'NOAUTH_A_NEWS_ADD' => 'Du hast keine Berechtigung Nachrichten hinzu zufügen.',
...
'NOAUTH_A_RAID_ADD' => 'Du hast keine Berechtigung Raids hinzu zufügen.',
...
'CONFIRM_DELETE_ITEM' => 'Bist du sicher, dass du dies Item ’%s’ von Spieler ’%s’ löschen möchtest?',
...
'CONFIRM_DELETE_ATTENDEE' => 'Bitte bestätige die Löscung von %s aus den %s Raid',
...
'VLOG_FACTION_DELETED' => '%s hat die Faktion %s gelöscht in %s',
'VLOG_FACTION_ADDED' => '%s hat die Faktion %s hinzugefügt in %s',
...
'VLOG_RACE_UPDATED' => '%s hat die Rasse race %s bearbeitet in %s',
...
'ERROR_NOSELECT' => 'Bitte wähle einen VON und einen ZU Mitgliedernamen',
...
'ADMIN_ADD_EVENT_SUCCESS' => 'Der Standardwert von %s für Ereignisse auf %s wurde erfolgreich zugefügt.',
...
'ADMIN_ADD_MEMBER_SUCCESS' => '%s wurde erfolgreich hinzugefügt in die Mitgliederliste.',
'ADMIN_ADD_MEMBER_FAIL' => 'Fehler : Mitglied %s kann nicht hinzugefügt weren, der Name ist bereits vergeben unter der Nummer %d',
...
'ADMIN_DEACTIVATE_MEMBER_SUCCESS' => 'Mitglied %s wurde deaktiviert wegen Inaktivität (%s)',
...
'ADMIN_ADD_GUILD_FAIL' => 'Die Gilde %s könnte nicht hinzugefügt werden.',
...
'ADMIN_ADD_CLASS_FAILED' => 'Die Klasse könnte nicht hinzugefügt werden denn den id %s ist schon vergeben.',
...
'INACTIVE_PERIOD' => 'Inaktivitäts Zeitraum',
...
'PLUGINS' => 'Plugins',
'DOWNLOAD_LATEST_PLUGINS' => 'LAden aktuellste Plugins herrunter ',
...
'ADD_RAID_VALUE_NOTE' => 'Einmaliger Raidbonus; wenn fehlend, gilt der Standardwert des Ereignisses',
...
'ADD_PRECONFIGGAME' => 'füge Vorprogrammieres Spiel hinzu',
'ADD_CUSTOMGAME' => 'füge Eigenes Spiel hinzu',
'LIST_GAMES' => 'Spieleliste',
'ADD_ATTENDEE' => 'fürge Teilnehmer hinzu',
...
'ATTENDEEADD_EXPLAIN' => 'Füget einen zusätzlichen Raidteilnehmer hinzu',
...
'DKPTIMEUNIT_EXPLAIN' => 'Kalkuliert x DKP als Verdient für jedes Zeit Intervall wo der Teilnehmer war im Raid present war.',
'GENERATE_ARMORY_URL' => 'Lege Hyperlink zum Armory an.',
'ARMORY_ENABLED' => 'Armoryverbindung eingeschaltet',
'TIMEUNIT' => 'Zeit Intervall',
'TIMEUNIT_EXPLAIN' => 'Dauer in Minuten für das DKP Zeitintervall. verwendet von Raidtracker und das manuelle Raidfenster',
'STANDARDDURATION' => 'durchschnittlicher Raid Dauer',
'STANDARDDURATION_EXPLAIN' => 'durchschnittlicher Raid Dauer in Stunden. Wird verwendet bei der Berechnung des Raid Endes im Raidfenster',
...
'TIME_OVERRIDE' => 'Ankreuzen zum überscheiben der individuellen Zeitboni von Raidtracker.',
'TITLE' => 'Titel',
...
'STANDARDDKP_ADVANTAGE' => '<strong>Vorteile</strong> : einfach. Keine Berechnung für Beuteverteilung notwendig .',
