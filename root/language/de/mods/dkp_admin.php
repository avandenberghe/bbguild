...
//Boss progress
'GENERAL' => 'Allgemaine Einstellungen',
...
'RP_ZONE' => 'Gebiete Einstellungen',
'RP_ZONE_EXPLAIN' => 'Hier kannst du die Gebietsbilder, ob Gebietsbilder mit Vorgangsanzeige aufgeführt werden, die Art, 
oder dass Gebiete ohne Siege angeszeigt werden (übersteuert die "schau an" Spalte), ob nie getötete Bosse versteckt bleiben.<br />In die Liste dan der Gebietsnamen, Kurzname, 
Bildname (ohne dateityp), ob das Gebiet Komplett besiegt worden ist. <br />Gebiete können gelöscht werden, aber dies löscht auch die Bosse des Gebietes<br />Zur Gebietszufügung, clicke den ’Zufügen’ Knopf. ' , 
