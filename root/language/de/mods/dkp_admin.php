...
'REGISTRATION_EXPLAIN' => 'Wenn du die Registrierung Taste drückst, werden ihr Domainname, phpBB-Version, bbDKP-Version nach bbDKP.com gesendet und du bekommst ein Registrierungsschlüssel. Dies ist frei. ',
//JAVASCRIPT
...
'NUMNEWMEMBERS' => 'Anzahl Neue Mitglieder zu zeigen',
...
'ARMORY_ENABLED_EXPLAIN' => 'ist die Armory API eingeschaltet für dieses Spiel ? (Nur WoW und Guildwars haben ein öffentlich zugänglicher Web API, aber bbDKP konsumiert nur den WoW API).',
'ARMORY_ENABLED_GUILD_EXPLAIN' => 'ist die Armory API eingeschaltet für diese Gilde ? <br/>(hängt auch von die Spiele-Einstellungen ab)',
...
'ACP_GAME_EXPLAIN' => 'Hier kannst du ein Spiel zur Standard-eEinstellung zurücksetzen',
'ACP_GAME_RESET' => 'Spiele einstellungen zurücksetzen. ',
...
'CONFIRM_DUPLICATE_RAID' => 'Bitte Bestätige das verzweifältigen vom Raid %s in %s.',
...
'REALM_AFTER' => 'Realm danach',
'GENDER_BEFORE' => 'Geschlecht vorher',
'GENDER_AFTER' => 'Geschlecht danach',
'RANK_BEFORE' => 'Rang vorher',
'RANK_AFTER' => 'Rang danach',
'ACHIEV_BEFORE' => 'Erfolge vorher',
'ACHIEV_AFTER' => 'Erfolge danach',
...
'ERROR_FROMTO' => 'Bitte wähle ein VON und ein ZU Mitgliedsname',
...
'ADMIN_ADD_MEMBER_FAIL' => 'Fehler : Mitglied %s kann nicht hinzugefügt weren, der Name ist bereits vergeben unter die Nummer %d',
...
'ADMIN_ADD_RACE_FAILED' => 'Die Rasse kann nicht hinzugefügt werden denn den id %s ist schon besetzt. ',
'ADMIN_ADD_RACE_SUCCESS' => 'Die Rasse %s wurde erfolgreich hinzugefügt. ',
'ADMIN_ADD_CLASS_FAILED' => 'Die Klasse könnte nicht hinzugefügt werden denn den id %s existiert schon.',
...
//Plugin Check System
'PLUGINS_INSTALLED'	 => 'Plugin installiert',
'PLUGINS_STATUS' 	 => 'Pluginstatus',

'NO_PLUGINS_INSTALLED'		=> 'Keine plugins installiert',
'ADD_PLUGINS_AVAIL'   		=> 'PLugins vorhanden',
'DOWNLOAD_PLUGINS'		    => 'PLugins hier herunterladen',
'DOWNLOAD_LATEST_PLUGINS'	=> 'Lade die letzte Version',
'DOWNLOAD_HERE' 			=> 'Hier hierunterladen',
'PLUGIN_UP_TO_DATE' 		=> 'Aktualisiert',
'LATESTPLUGINVERSION'	   	=> 'Nicht aktualisiert ', 
'PLUGIN_VERSION_NOTONLINE' 	=> 'kann den Server nicht anrufen',
...
'NEWMEMBERS_SETTING'	=> 'Neuanmeldungs-Einstellungen',
'NO_IMAGE' => 'Kein Bild',
...
'NUMNEWMEMBERS'	=> 'Anzahl Neue Benutzer', 
...
'SHOW_NEWMEMBERS_BLOCK'	=> 'Zeige Neue Benutzerliste',
